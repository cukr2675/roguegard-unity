...
//{
//    [CustomPropertyDrawer(typeof(OchalikeMorphData.Item), true)]
//    public class OchalikeMorphDataItemDrawer : PropertyDrawer
//    {
...
//            {
//                var member = property.FindPropertyRelative("_name");

//                var height = EditorGUI.GetPropertyHeight(member);
//                var memberPosition = new Rect(position.x, y, position.width, height);

//                EditorGUI.PropertyField(memberPosition, member);
//                y += height + EditorGUIUtility.standardVerticalSpacing;
//            }
//            {
//                var member = property.FindPropertyRelative("_hasMorphBareSprite");
...
//            }
//            {
//                var member = property.FindPropertyRelative("_morphBareColor");
