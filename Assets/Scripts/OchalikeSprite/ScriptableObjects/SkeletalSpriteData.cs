...
{
    [CreateAssetMenu(menuName = "OchalikeSprite/SkeletalSprite")]
    public class SkeletalSpriteData : ScriptableObject
    {
        [SerializeField] private int _pixelsPerUnit = OchalikeSpriteUtility.DefaultPixelsPerUnit;
        public int PixelsPerUnit { get => _pixelsPerUnit; set => _pixelsPerUnit = value; }

        [SerializeField] private float _lightDarkThreshold = OchalikeSpriteUtility.LightDarkThreshold;
