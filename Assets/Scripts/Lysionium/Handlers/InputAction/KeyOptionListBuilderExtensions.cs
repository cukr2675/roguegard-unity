...
namespace Lysionium
{
    public static class KeyOptionListBuilderExtensions
    {
        ...
        public static TBuilder Option<TMgr, TArg, TBuilder>(
            ...
            where TArg : IListMenuArg
        {
            return builder.Option(KeyOption.Create(name, onPerform, style, onStart, onCancel));
        }
        ...
        public static TBuilder Option<TMgr, TArg, TBuilder>(
            ...
            where TArg : IListMenuArg
        {
            return builder.Option(KeyOption.Create<TMgr, TArg>(name, onPerform, style, onStart, onCancel));
        }

        public static TBuilder OptionPerformOrCancel<TMgr, TArg, TBuilder>(
            this IKeyOptionListBuilder<TMgr, TArg, TBuilder> builder,
            ...
            where TArg : IListMenuArg
        {
            return builder.Option(KeyOption.Create(name, onPerformOrCancel, style, onStart, onPerformOrCancel));
        }
        ...
        public static TBuilder OptionPerformOrCancel<TMgr, TArg, TBuilder>(
            ...
            where TArg : IListMenuArg
        {
            return builder.Option(KeyOption.Create<TMgr, TArg>(name, onPerformOrCancel, style, onStart, onPerformOrCancel));
        }
    }
}
