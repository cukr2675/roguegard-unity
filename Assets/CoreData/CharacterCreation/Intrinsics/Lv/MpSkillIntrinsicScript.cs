...
{
    public abstract class MpSkillIntrinsicScript : ScriptIntrinsicOptionAsset.IntrinsicScript
    {
        /// <summary>
        ...
        {
            private static ScriptIntrinsicOptionAsset parent;
            ...
            protected MpSkillSortedIntrinsic(ScriptIntrinsicOptionAsset parent, int lv)
            {
