...
{
    [CreateAssetMenu(menuName = "Roguegard/Character Creation/Intrinsic/Script")]
    [Objforming.Referable]
    public class ScriptIntrinsicOptionAsset : IntrinsicOptionAsset
    {
        ...
        [SerializeField] private ScriptField<IntrinsicScript> _script = null;
        protected IntrinsicScript ScriptRef => _script.Ref;
        ...
        public abstract class IntrinsicScript : ReferableScript
        {
            public virtual Spanning<IMemberSource> MemberSources => Spanning<IMemberSource>.Empty;

            public virtual int GetLv(
                ScriptIntrinsicOptionAsset parent, IReadOnlyIntrinsic intrinsic, ICharacterCreationData characterCreationData)
            {
