...
namespace Roguegard
{
    ...
    public class RogueDungeonGeneratorAsset : ScriptableObject
    {
        ...
        [Header("Tiles")]
        [SerializeField] private RogueTileAsset[] _fillTiles;
        public Spanning<IRogueTile> FillTiles => _fillTiles;
        [Space]
        [SerializeField] private RogueTileAsset[] _noiseTiles;
        ...
        [Space]
        [SerializeField] private RogueTileAsset[] _roomGroundTiles;
        public Spanning<IRogueTile> RoomGroundTiles => _roomGroundTiles;
        [SerializeField] private RogueTileAsset[] _roomWallTiles;
        ...
        {
            [SerializeField] private StandardRogueTileInfoAsset[] _tiles = null;
