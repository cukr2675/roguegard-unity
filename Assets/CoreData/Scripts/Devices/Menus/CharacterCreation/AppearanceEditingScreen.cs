            ...
            view.Show(list, manager, arg)
                ...
                .Init(
                    ...
                    .Case(
                        ...
                        .OnClick((appearance, manager, arg) => manager.PushScreen(OptionScreen, arg.Self, other: appearance)))

                    .Otherwise(
                        _ => _
                        .NameFrom(_ => "+ 見た目を追加")
                        .OnClick((_, manager, arg) => manager.PushScreen(AddScreen, arg.Self, other: typeof(Appearance)))))
