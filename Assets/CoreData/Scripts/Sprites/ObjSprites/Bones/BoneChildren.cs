...
namespace Roguegard
{
        ...
        where T : ISortableBone<T>
    {
        ...
        Spanning<T> ISortableBoneChildren<T>.NormalFrontChildren => _normalFrontChildren;
        Spanning<T> ISortableBoneChildren<T>.NormalRearChildren
            => _normalRearChildren;
        Spanning<T> ISortableBoneChildren<T>.BackFrontChildren
            => _backFrontChildren;
        Spanning<T> ISortableBoneChildren<T>.BackRearChildren
            => _backRearChildren;
